...
- __Application__ means the software program provided by the Company downloaded by You on any electronic device, named Pilot Card


- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to National Technology Center for Waterways and Ports IIT Madras, Room N0.606 NAC Building.
